  ...
  return (
    <div className="  w-full flex flex-col lg:flex-row justify-between  items-center mb-24 mt-10 gap-10 ">
      <div className=" lg:w-2/4  ">
        <h2 className=" text-5xl font-bold font-sans pb-8 ">
          Discover the Best{" "}
        ...
        <button className=" px-4 py-3  text-white w-44 rounded-full bg-black mt-5 items-center justify-center ">
          Destinations
        </button>
      </div>
      <div className=" pl-8 w-full lg:w-2/4 items-center  ">
        <Image
